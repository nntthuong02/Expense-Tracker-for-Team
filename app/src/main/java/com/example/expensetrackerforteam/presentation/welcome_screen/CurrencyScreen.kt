            ...
            if (showBottomSheet) {
                ModalBottomSheet(
                    ...
                    Button(
                        ...
                        onClick = {
                        Log.d("test", "test1")
                        welcomeViewModel.saveCurrency(selectedCountry.currencyCode)
                        ...
                        welcomeViewModel.createParticipants()
                        Log.d("MyApp", "createParticipants executed")
                        welcomeViewModel.saveOnboardingState(completed = true)
                        Log.d("MyApp", "saveOnboardingState executed")


                        Log.d("MyApp", "navigate executed")
